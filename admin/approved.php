  ...
  <div class="o-page">
      ...
      <aside class="c-sidebar">
        ...
        <div class="c-sidebar__body">
          ...
          <ul class="c-sidebar__list">
            ...
            <li>
              <a class="c-sidebar__link" href="./approved.php" style="color: green">
                <i class="c-sidebar__icon feather icon-bar-chart-2"></i>Approved
              </a>
            </li>
            <li>
              <a class="c-sidebar__link" href="./complete.php">
                <i class="c-sidebar__icon feather icon-pie-chart"></i>Complete
              </a>
            </li>
            <li>
              <a class="c-sidebar__link" href="./filter.php">
    ...
    <main class="o-page__content">
      <header class="c-navbar u-mb-medium">
        ...
        <h2 class="c-navbar__title">Officer Terminal - Approved Permit Applications</h2>
                ...
                <div class="table100 ver5 m-b-110">
                      <?php
                        try{
                          ...
                          $sql = "SELECT * FROM permits_table WHERE curr_status = \"Approved\" ORDER BY permit_id";
                          ...
                          if($res->rowCount() > 0){
                            echo '<div class="table100-head">
                                  ...
                                  <div class="table100-body js-pscroll ps ps--active-y" style="min-height:300px;">
                                      <table>
                                        <tbody>
                                          ';
                                  $i = 0;
                            while($row = $res->fetch(PDO::FETCH_ASSOC)){
                              echo '<tr id="'.$row['permit_id'].'" class="row100 body" onclick="show_hide_row(\'hidden_row'.$row['permit_id'].'\');" >
                                            ...
                                            <td class="cell100 column6 c-dropdown dropdown" style="width: 100%">
                                              <span class="c-icon c-icon--medium u-md-small dropdown-toggle" id="'.$row['permit_id'].'" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="button">
                                                <i class="feather icon-edit"></i>
                                              <div class="c-dropdown__menu has-arrow dropdown-menu dropdown-menu-right" aria-labelledby="'.$row['permit_id'].'">
                                                <li class="c-dropdown__item dropdown-item" onclick="modify_row('.$row['permit_id'].',\'com_'.$row['permit_id'].'\')" id="com_'.$row['permit_id'].'" data-value="Complete">Complete</li>
                                                <li class="c-dropdown__item dropdown-item" onclick="modify_row('.$row['permit_id'].',\'rej_'.$row['permit_id'].'\')" id="rej_'.$row['permit_id'].'" data-value="Reject">Reject</li>
                                              </div>
                                              </span>
                                            </td><tr id="hidden_row'.$row['permit_id'].'" class="hidden_row show">
                              ...
                              echo '
                                    ...
                                    </div><div class="ps__rail-y" style="top: 0; height: 0; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div>';
                              echo '<div class="ps__rail-x" style="left: 0px; bottom: 0px;"></div>';
                              // Free result set
                            unset($result);
                          } else{echo "There are currently no approved applications.";}
                            // Close connection
                            unset($conn);
