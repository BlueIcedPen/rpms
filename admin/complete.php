  ...
  <div class="o-page">
      ...
      <aside class="c-sidebar">
        ...
        <div class="c-sidebar__body">
          ...
          <ul class="c-sidebar__list">
            ...
            <li>
              <a class="c-sidebar__link" href="./completed.php" style="color: green">
    ...
    <main class="o-page__content">
      <header class="c-navbar u-mb-medium">
        ...
        <h2 class="c-navbar__title">Officer Terminal - Complete Permit Applications</h2>
                ...
                <div class="table100 ver5 m-b-110">
                      <?php
                        try{
                          ...
                          $sql = "SELECT * FROM permits_table WHERE curr_status = \"Complete\" ORDER BY permit_id";
                          ...
                          // if($res->fetch(PDO::FETCH_ASSOC)){
                            if($res->rowCount() > 0){
                              ...
                              while($row = $res->fetch(PDO::FETCH_ASSOC)){
                                ...
                                // Free result set
                              unset($result);
                            } else{echo "There are currently no completed applications.";}
                            // Close connection
                            unset($conn);
