<?php
    if(isset($_POST['reg_submit'])){
        ...
        try{
            ...
            $sql = "INSERT INTO users_table (user_email, user_firstname, user_lastname, phone, user_password, salt)
            VALUES ( '".$email."', '".$first_name."', '".$last_name."', '".$user_phone."', '".$passhash."', '".$salt."')";
