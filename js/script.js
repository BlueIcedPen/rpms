/*------------------------------------------------------------------
 Deft - Multipurpose Coming Soon Template
...
$(function() {
    checkerx($("#subscribe-form"), $("#subscribe-result"));
    // Turn the given MailChimp form into an ajax version of it.
    // If resultElement is given, the subscribe result is set as html to
    // that element.
    function checkerx($form, $resultElement){
